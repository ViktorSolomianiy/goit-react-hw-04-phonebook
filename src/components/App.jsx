...
export function App() {
  ...
  // Додаємо контакти у localStorage
  useEffect(() => {
  ...
  const addContacts = (name, number) => {
    ...
    setContacts(prevContacts => [...prevContacts, contactsArr]);
  };
  ...
  return (
    <div>
      ...
      <ContactsForm contacts={contacts} onSubmit={addContacts} />

      <div className="contacts__container">
        <h2 className="contacts__title">Contacts</h2>

        <Filter filter={filter} changeFilter={changeFilter} />
        <ContactsList options={visibleContacts} onDelete={deleteContact} />
      </div>
    </div>
  );
}
